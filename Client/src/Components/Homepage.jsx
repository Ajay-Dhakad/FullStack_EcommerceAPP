...
function Homepage() {
  ...
  const products = [
    {
      title: "Men's Fashion",
      imageUrl: "https://images.unsplash.com/photo-1617113930975-f9c7243ae527?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTB8fG1lbnMlMjBmYXNoaW9ufGVufDB8fDB8fHww",
      link:'/category/men'
    },
    {
      title: "Women's Fashion",
      imageUrl: "https://images.unsplash.com/photo-1617922001439-4a2e6562f328?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8N3x8d29tZW5zJTIwZmFzaGlvbnxlbnwwfHwwfHx8MA%3D%3D",
      link:'/category/women'
    },
    {
      title: "Accessories",
        ...
        <div className="content">
          <div className="text">
            ...
            >
              ...
              shopping experience where excellence is not just a commitment but
              our brand's foundation
            </motion.p>
            <motion.button
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
...

          {
            products.map((product,index) => {
              return(
                ...
                }} initial={{opacity:0,translateX:-100}} whileInView={{opacity:1,translateX:0}} transition={{delay:.3*index,duration:1.5}} viewport={{once:true}} className="product">
      ...
      <div className="whychooseus">
          ...
          <div className="services">
              <div className="service">
                <img src="https://www.iconsdb.com/icons/preview/white/truck-xxl.png" alt="" />
                <h2>FREE SHIPPING</h2>
                <p>
              ...
              <div className="service">
                <img src="https://www.iconsdb.com/icons/preview/white/padlock-3-xxl.png" alt="" />
              ...
              <div className="service">
                <img src="https://www.iconsdb.com/icons/preview/white/pin-8-xxl.png" alt="" />
              ...
              <div className="service">
                <img src="https://www.iconsdb.com/icons/preview/white/return-xxl.png" alt="" />
                <h2>EASY RETURNS</h2>
                <p>
